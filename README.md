...
**1.**  Fork [this](https://github.com/Eaglion-Programmers/curated-resources) repository.

**2.**  Clone your forked copy of the project.
```
git clone --depth 1 https://github.com/<your_user_name>/curated-resources.git
```
...
```
git remote add upstream https://github.com/Eaglion-Programmers/curated-resources
```
